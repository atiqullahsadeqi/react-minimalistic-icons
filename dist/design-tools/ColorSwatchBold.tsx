...
export interface ColorSwatchBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ColorSwatchBold: React.FC<ColorSwatchBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M21.9999 16.5V19.5C21.9999 20.88 20.8799 22 19.4999 22H12.3599C11.4699 22 11.0299 20.93 11.6499 20.3L17.5199 14.3C17.7099 14.11 17.9699 14 18.2299 14H19.4999C20.8799 14 21.9999 15.12 21.9999 16.5Z" fill={color}/>
<path d="M18.37 11.29L15.66 14L13.2 16.45C12.57 17.08 11.49 16.64 11.49 15.75C11.49 12.54 11.49 7.26 11.49 7.26C11.49 6.99 11.6 6.74 11.78 6.55L12.7 5.63C13.68 4.65 15.26 4.65 16.24 5.63L18.36 7.75C19.35 8.73 19.35 10.31 18.37 11.29Z" fill={color}/>
