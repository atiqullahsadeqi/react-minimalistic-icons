...
export interface Brush4BrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Brush4Broken: React.FC<Brush4BrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.8 12L19.69 14.01C19.63 14 19.57 14 19.5 14H4.50004C4.43004 14 4.37004 14 4.31004 14.01L3.83004 5.3C3.65004 3.53 5.04004 2 6.81004 2H17.19C18.96 2 20.35 3.53 20.17 5.3L20.02 8.01" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
