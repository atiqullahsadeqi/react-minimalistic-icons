...
export interface PenTool2TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PenTool2Twotone: React.FC<PenTool2TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M10.7498 22.5H13.2698C14.2298 22.5 14.8498 21.82 14.6698 20.99L14.2598 19.1801H9.75983L9.34984 20.99C9.16984 21.77 9.84983 22.5 10.7498 22.5Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M14.2601 19.1701L15.9901 17.63C16.9601 16.77 17.0001 16.17 16.2301 15.2L13.18 11.33C12.54 10.52 11.4901 10.52 10.8501 11.33L7.80006 15.2C7.03006 16.17 7.03005 16.8 8.04005 17.63L9.77006 19.1701" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12.0098 11.12V13.65" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</g>
...
<path d="M10.52 3.56C6.71 4.01 3.75 7.23998 3.75 11.17" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
