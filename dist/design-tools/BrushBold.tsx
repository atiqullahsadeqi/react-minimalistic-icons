...
export interface BrushBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BrushBold: React.FC<BrushBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
