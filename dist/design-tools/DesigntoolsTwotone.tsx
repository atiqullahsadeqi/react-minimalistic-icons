...
export interface DesigntoolsTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DesigntoolsTwotone: React.FC<DesigntoolsTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M11.25 3.85L7.55005 7.55" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
<path opacity="0.4" d="M20.1199 12.73L17.1599 15.68" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
</g>
<defs>
