...
export interface LifebuoyLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LifebuoyLinear: React.FC<LifebuoyLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M4.8999 4.92999L8.4399 8.45999" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
