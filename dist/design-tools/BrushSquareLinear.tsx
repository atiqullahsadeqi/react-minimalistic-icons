...
export interface BrushSquareLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BrushSquareLinear: React.FC<BrushSquareLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
