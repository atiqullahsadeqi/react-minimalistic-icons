...
export interface MainComponentBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MainComponentBulk: React.FC<MainComponentBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M13.06 12L18.28 17.22L17.22 18.28L12 13.06L6.77997 18.28L5.71997 17.22L10.94 12L5.71997 6.78L6.77997 5.72L12 10.94L17.22 5.72L18.28 6.78L13.06 12Z" fill={color}/>
</svg>
