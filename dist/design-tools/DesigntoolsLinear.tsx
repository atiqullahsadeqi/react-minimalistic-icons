...
export interface DesigntoolsLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DesigntoolsLinear: React.FC<DesigntoolsLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g clip-path="url(#clip0_1_12896)">
<path d="M21.81 3.94C20.27 7.78 16.41 13 13.18 15.59L11.21 17.17C10.96 17.35 10.71 17.51 10.43 17.62C10.43 17.44 10.42 17.24 10.39 17.05C10.28 16.21 9.90002 15.43 9.23002 14.76C8.55002 14.08 7.72002 13.68 6.87002 13.57C6.67002 13.56 6.47002 13.54 6.27002 13.56C6.38002 13.25 6.55002 12.96 6.76002 12.72L8.32002 10.75C10.9 7.52 16.14 3.64 19.97 2.11C20.56 1.89 21.13 2.05 21.49 2.42C21.87 2.79 22.05 3.36 21.81 3.94Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M14.24 14.47C14.24 11.86 12.12 9.74001 9.51001 9.74001" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M11.25 3.85001L7.55005 7.55001" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
<path d="M20.1199 12.73L17.1599 15.68" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
</g>
<defs>
<clipPath id="clip0_1_12896">
