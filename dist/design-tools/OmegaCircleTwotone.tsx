...
export interface OmegaCircleTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const OmegaCircleTwotone: React.FC<OmegaCircleTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
