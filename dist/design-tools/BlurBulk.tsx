...
export interface BlurBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BlurBulk: React.FC<BlurBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M12.61 2.21C12.25 1.93 11.7501 1.93 11.3901 2.21C9.49007 3.66 3.88003 8.39 3.91003 13.9C3.91003 18.36 7.54007 22 12.0101 22C16.4801 22 20.11 18.37 20.11 13.91C20.12 8.48 14.5 3.67 12.61 2.21Z" fill={color}/>
