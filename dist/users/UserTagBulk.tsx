...
export interface UserTagBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const UserTagBulk: React.FC<UserTagBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M14.6799 15.0601C15.4899 15.0601 15.9599 14.1601 15.5099 13.4901C14.8299 12.4801 13.5099 11.8 11.9999 11.8C10.4899 11.8 9.16991 12.4801 8.48991 13.4901C8.03991 14.1601 8.50993 15.0601 9.31993 15.0601H14.6799Z" fill={color}/>
</svg>
