...
export interface UserMinusTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const UserMinusTwotone: React.FC<UserMinusTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M3.40991 22C3.40991 18.13 7.25994 15 11.9999 15C12.9599 15 13.8899 15.13 14.7599 15.37" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
