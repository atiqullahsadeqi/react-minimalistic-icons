...
export interface UserTickBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const UserTickBulk: React.FC<UserTickBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
