...
export interface ProfileTickBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ProfileTickBulk: React.FC<ProfileTickBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
