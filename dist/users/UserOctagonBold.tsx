...
export interface UserOctagonBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const UserOctagonBold: React.FC<UserOctagonBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
