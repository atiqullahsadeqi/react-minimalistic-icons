...
export interface PeopleLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PeopleLinear: React.FC<PeopleLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M16.9702 14.44C18.3402 14.67 19.8502 14.43 20.9102 13.72C22.3202 12.78 22.3202 11.24 20.9102 10.3C19.8402 9.59004 18.3102 9.35003 16.9402 9.59003" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
