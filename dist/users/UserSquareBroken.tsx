...
export interface UserSquareBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const UserSquareBroken: React.FC<UserSquareBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M18.1401 21.62C17.2601 21.88 16.2201 22 15.0001 22H9.00011C7.78011 22 6.74011 21.88 5.86011 21.62C6.08011 19.02 8.75011 16.97 12.0001 16.97C15.2501 16.97 17.9201 19.02 18.1401 21.62Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
