...
export interface PeopleBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PeopleBroken: React.FC<PeopleBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M14.91 17.78C13.32 16.72 10.69 16.72 9.08997 17.78C7.67997 18.72 7.67997 20.26 9.08997 21.2C10.69 22.27 13.31 22.27 14.91 21.2" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
