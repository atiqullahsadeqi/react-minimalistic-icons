...
export interface ProfileAddBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ProfileAddBold: React.FC<ProfileAddBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
