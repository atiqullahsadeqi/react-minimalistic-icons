...
export interface HomeTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HomeTwotone: React.FC<HomeTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.34" d="M12 18V15" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
