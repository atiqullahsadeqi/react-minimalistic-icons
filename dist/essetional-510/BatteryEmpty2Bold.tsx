...
export interface BatteryEmpty2BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BatteryEmpty2Bold: React.FC<BatteryEmpty2BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
