...
export interface FilterTickBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FilterTickBroken: React.FC<FilterTickBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
