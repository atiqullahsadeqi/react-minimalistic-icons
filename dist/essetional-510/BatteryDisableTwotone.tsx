...
export interface BatteryDisableTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BatteryDisableTwotone: React.FC<BatteryDisableTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.34" d="M13 19.0001C17 19.0001 18 18.0001 18 14.0001V10.0001C18 6.61008 17.28 5.37008 14.63 5.08008" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
