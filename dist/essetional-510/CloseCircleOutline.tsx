...
export interface CloseCircleOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloseCircleOutline: React.FC<CloseCircleOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
