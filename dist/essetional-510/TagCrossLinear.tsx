...
export interface TagCrossLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TagCrossLinear: React.FC<TagCrossLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M11.0601 14.47L16.0001 9.53003" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
</svg>
