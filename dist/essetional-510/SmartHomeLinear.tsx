...
export interface SmartHomeLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SmartHomeLinear: React.FC<SmartHomeLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M8 22C7.99 21.24 7.86 20.53 7.63 19.88C7.04 18.21 5.78 16.96 4.12 16.37C3.47 16.14 2.76 16.01 2 16" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
