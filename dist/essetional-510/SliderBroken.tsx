...
export interface SliderBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SliderBroken: React.FC<SliderBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M15 2C17.5 2 19 3.8 19 6V18C19 20.2 17.5 22 15 22H9C6.5 22 5 20.2 5 18V6C5 3.8 6.5 2 9 2H10.98" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
