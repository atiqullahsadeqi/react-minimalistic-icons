...
export interface ForbiddenTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ForbiddenTwotone: React.FC<ForbiddenTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M4.93994 19.0799L19.0799 4.93994" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
