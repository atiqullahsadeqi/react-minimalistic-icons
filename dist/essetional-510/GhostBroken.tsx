...
export interface GhostBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const GhostBroken: React.FC<GhostBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
