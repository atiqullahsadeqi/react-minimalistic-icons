...
export interface MinusCirlceTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MinusCirlceTwotone: React.FC<MinusCirlceTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.34" d="M7.91992 12H15.9199" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
