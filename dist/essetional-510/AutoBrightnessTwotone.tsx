...
export interface AutoBrightnessTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const AutoBrightnessTwotone: React.FC<AutoBrightnessTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
