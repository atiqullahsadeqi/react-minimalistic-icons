...
export interface CloseCircleBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloseCircleBulk: React.FC<CloseCircleBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
