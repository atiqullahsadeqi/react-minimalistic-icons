...
export interface HappyemojiTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HappyemojiTwotone: React.FC<HappyemojiTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.34" d="M7.20996 16C8.25996 17.51 10.02 18.5 12 18.5C13.98 18.5 15.73 17.51 16.79 16" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
