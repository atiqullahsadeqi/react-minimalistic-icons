...
export interface GrammerlyTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const GrammerlyTwotone: React.FC<GrammerlyTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M15.8399 16.0701C13.7199 18.0701 10.2799 18.0701 8.16992 16.0701" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
