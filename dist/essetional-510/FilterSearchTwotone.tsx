...
export interface FilterSearchTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FilterSearchTwotone: React.FC<FilterSearchTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
