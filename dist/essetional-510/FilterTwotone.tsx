...
export interface FilterTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FilterTwotone: React.FC<FilterTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
