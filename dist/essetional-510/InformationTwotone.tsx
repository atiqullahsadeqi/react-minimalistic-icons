...
export interface InformationTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const InformationTwotone: React.FC<InformationTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M12 8.12988V12.9599" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
