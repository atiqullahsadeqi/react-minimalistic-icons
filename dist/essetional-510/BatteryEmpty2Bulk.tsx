...
export interface BatteryEmpty2BulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BatteryEmpty2Bulk: React.FC<BatteryEmpty2BulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
