...
export interface InfoCircleOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const InfoCircleOutline: React.FC<InfoCircleOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
