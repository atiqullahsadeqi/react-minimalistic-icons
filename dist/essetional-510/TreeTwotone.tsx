...
export interface TreeTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TreeTwotone: React.FC<TreeTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M12 22V18" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
