...
export interface DangerTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DangerTwotone: React.FC<DangerTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.34" d="M12 9V14" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path opacity="0.34" d="M11.9946 17H12.0036" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
