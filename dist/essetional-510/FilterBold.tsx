...
export interface FilterBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FilterBold: React.FC<FilterBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.3499 3.6301L6.7999 9.3201C6.4599 9.8701 5.6799 9.9501 5.2299 9.4801L4.2999 8.5001C3.7999 8.0001 3.3999 7.1001 3.3999 6.5001V4.2001C3.3999 3.0001 4.2999 2.1001 5.3999 2.1001H9.4999C10.2799 2.1001 10.7599 2.9601 10.3499 3.6301Z" fill={color}/>
</svg>
