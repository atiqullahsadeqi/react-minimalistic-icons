...
export interface FilterSearchBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FilterSearchBroken: React.FC<FilterSearchBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M14.3201 19.0699C14.3201 19.6799 13.92 20.4799 13.41 20.7899L12.0001 21.7C10.6901 22.51 8.87006 21.5999 8.87006 19.9799V14.6299C8.87006 13.9199 8.47006 13.0099 8.06006 12.5099L4.22003 8.46994C3.71003 7.95994 3.31006 7.05995 3.31006 6.44995" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
