...
export interface FilterLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FilterLinear: React.FC<FilterLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.93 2.1001L6 10.0001" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
