...
export interface FlashCircleBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FlashCircleBold: React.FC<FlashCircleBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
