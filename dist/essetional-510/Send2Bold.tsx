...
export interface Send2BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Send2Bold: React.FC<Send2BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
