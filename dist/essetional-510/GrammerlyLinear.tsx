...
export interface GrammerlyLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const GrammerlyLinear: React.FC<GrammerlyLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M15.8399 16.0703C13.7199 18.0703 10.2799 18.0703 8.16992 16.0703" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
