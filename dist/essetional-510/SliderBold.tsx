...
export interface SliderBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SliderBold: React.FC<SliderBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M18 16.01C18.55 16.01 19 16.46 19 17.01V18C19 20.2 17.5 22 15 22H9C6.5 22 5 20.2 5 18V17.01C5 16.46 5.45 16.01 6 16.01H18Z" fill={color}/>
