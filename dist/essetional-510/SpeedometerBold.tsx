...
export interface SpeedometerBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SpeedometerBold: React.FC<SpeedometerBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12.0001 22C14.143 22 15.8801 20.2629 15.8801 18.12C15.8801 15.9771 14.143 14.24 12.0001 14.24C9.85725 14.24 8.12012 15.9771 8.12012 18.12C8.12012 20.2629 9.85725 22 12.0001 22Z" fill={color}/>
