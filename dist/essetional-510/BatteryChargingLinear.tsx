...
export interface BatteryChargingLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BatteryChargingLinear: React.FC<BatteryChargingLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.0002 8L8.1102 10.5C7.7202 11.17 8.2002 12 8.9702 12H11.2702C12.0402 12 12.5202 12.83 12.1402 13.5L10.0002 16" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
