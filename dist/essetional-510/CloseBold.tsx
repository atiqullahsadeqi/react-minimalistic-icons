...
export interface CloseBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloseBold: React.FC<CloseBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
