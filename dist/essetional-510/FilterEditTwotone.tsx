...
export interface FilterEditTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FilterEditTwotone: React.FC<FilterEditTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
