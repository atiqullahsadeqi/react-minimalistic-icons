...
export interface BatteryChargingTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BatteryChargingTwotone: React.FC<BatteryChargingTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.34" d="M10.0002 8L8.1102 10.5C7.7202 11.17 8.2002 12 8.9702 12H11.2702C12.0402 12 12.5202 12.83 12.1402 13.5L10.0002 16" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
