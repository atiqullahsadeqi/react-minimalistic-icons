...
export interface HomeBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HomeBroken: React.FC<HomeBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
