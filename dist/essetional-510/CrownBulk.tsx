...
export interface CrownBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CrownBulk: React.FC<CrownBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22.0001 5.71V15.29C22.0001 18.05 19.7601 20.29 17.0001 20.29H7.00007C6.54007 20.29 6.10007 20.23 5.67007 20.11C5.05007 19.94 4.85007 19.15 5.31007 18.69L15.9401 8.06C16.1601 7.84 16.4901 7.79 16.8001 7.85C17.1201 7.91 17.4701 7.82 17.7201 7.58L20.2901 5C21.2301 4.06 22.0001 4.37 22.0001 5.71Z" fill={color}/>
