...
export interface SlashTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SlashTwotone: React.FC<SlashTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.34" d="M18.8999 5L4.8999 19" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
