...
export interface TriangleLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TriangleLinear: React.FC<TriangleLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M21.4401 19.9999L12.0001 13.3899L2.56006 19.9999" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
