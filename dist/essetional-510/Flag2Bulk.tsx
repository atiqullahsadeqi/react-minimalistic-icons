...
export interface Flag2BulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Flag2Bulk: React.FC<Flag2BulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M6.44995 22C6.03995 22 5.69995 21.66 5.69995 21.25V2.75C5.69995 2.34 6.03995 2 6.44995 2C6.85995 2 7.19995 2.34 7.19995 2.75V21.25C7.19995 21.66 6.85995 22 6.44995 22Z" fill={color}/>
