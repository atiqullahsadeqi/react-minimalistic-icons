...
export interface FilterSquareTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FilterSquareTwotone: React.FC<FilterSquareTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
