...
export interface CallIncomingBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallIncomingBroken: React.FC<CallIncomingBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M16.2 7.8H21M16.2 4.95V3V4.95ZM16.2 7.8V7.01V7.8Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
