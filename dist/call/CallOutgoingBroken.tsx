...
export interface CallOutgoingBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallOutgoingBroken: React.FC<CallOutgoingBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M20 3.80005H15.2M20 6.65005V8.60005V6.65005ZM20 3.80005V4.59005V3.80005Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
