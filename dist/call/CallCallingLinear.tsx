...
export interface CallCallingLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallCallingLinear: React.FC<CallCallingLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 9C22 5.13 18.87 2 15 2" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
