...
export interface CallIncomingTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallIncomingTwotone: React.FC<CallIncomingTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M16.2 7.8H21M16.2 7.8V3V7.8Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
