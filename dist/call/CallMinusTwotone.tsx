...
export interface CallMinusTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallMinusTwotone: React.FC<CallMinusTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M15.5 6H20.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
