...
export interface CallRemoveLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallRemoveLinear: React.FC<CallRemoveLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M16.23 7.76998L19.77 4.22998" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
