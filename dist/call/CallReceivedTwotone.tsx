...
export interface CallReceivedTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallReceivedTwotone: React.FC<CallReceivedTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M15 5.96997L17 7.96997L21 3.96997" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
