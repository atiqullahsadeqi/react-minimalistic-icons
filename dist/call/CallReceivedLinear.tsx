...
export interface CallReceivedLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallReceivedLinear: React.FC<CallReceivedLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M15 5.96997L17 7.96997L21 3.96997" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
