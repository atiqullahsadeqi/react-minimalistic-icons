...
export interface CallReceivedBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallReceivedBroken: React.FC<CallReceivedBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M15 5.9762L17 7.9762L21 3.9762" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
