...
export interface CallIncomingLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallIncomingLinear: React.FC<CallIncomingLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M16.2 7.8H21M16.2 7.8V3V7.8Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
