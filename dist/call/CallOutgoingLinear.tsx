...
export interface CallOutgoingLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallOutgoingLinear: React.FC<CallOutgoingLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M20 4H15.2M20 4V8.8V4Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
