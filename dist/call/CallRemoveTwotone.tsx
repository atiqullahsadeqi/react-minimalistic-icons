...
export interface CallRemoveTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallRemoveTwotone: React.FC<CallRemoveTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M16.2305 7.77047L19.7705 4.23047" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19.7705 7.77047L16.2305 4.23047" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
