...
export interface CallSlashBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallSlashBroken: React.FC<CallSlashBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
