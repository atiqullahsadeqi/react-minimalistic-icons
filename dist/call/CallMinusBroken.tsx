...
export interface CallMinusBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CallMinusBroken: React.FC<CallMinusBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M15.5 6H20.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
