...
export interface BagTickTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BagTickTwotone: React.FC<BagTickTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M9.61914 16L11.1191 17.5L14.3691 14.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
