...
export interface ShopTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ShopTwotone: React.FC<ShopTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M3.00977 11.2197V15.7097C3.00977 20.1997 4.80977 21.9997 9.29977 21.9997H14.6898C19.1798 21.9997 20.9798 20.1997 20.9798 15.7097V11.2197" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
