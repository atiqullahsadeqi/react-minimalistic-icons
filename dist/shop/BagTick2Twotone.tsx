...
export interface BagTick2TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BagTick2Twotone: React.FC<BagTick2TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M10.4399 15L11.0899 15.65C11.2799 15.84 11.5899 15.85 11.7799 15.66L13.5599 14.02" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
