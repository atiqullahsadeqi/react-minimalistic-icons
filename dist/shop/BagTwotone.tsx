...
export interface BagTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BagTwotone: React.FC<BagTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M9.75977 14V17.55" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
<path d="M14.3594 14V17.55" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
</g>
