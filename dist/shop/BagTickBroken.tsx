...
export interface BagTickBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BagTickBroken: React.FC<BagTickBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M9.62012 16L11.1201 17.5L14.3701 14.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
