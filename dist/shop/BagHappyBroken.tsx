...
export interface BagHappyBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BagHappyBroken: React.FC<BagHappyBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M15.3401 15.28C15.4401 14.95 15.5001 14.61 15.5001 14.25" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M8.5 14.25C8.5 16.17 10.08 17.75 12 17.75C12.36 17.75 12.71 17.69 13.04 17.59" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M3.5 10L4.19 14.25" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
</svg>
