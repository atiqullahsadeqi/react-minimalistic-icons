...
export interface ShoppingBagBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ShoppingBagBulk: React.FC<ShoppingBagBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M16.49 22H7.50996C3.99996 22 3.23997 19.99 3.52997 17.53L4.42996 10.03C4.65996 8.09 4.99996 6.5 8.39996 6.5H15.6C19 6.5 19.34 8.09 19.57 10.03L20.32 16.28L20.47 17.53C20.48 17.61 20.49 17.69 20.5 17.77C20.71 20.12 19.89 22 16.49 22Z" fill={color}/>
