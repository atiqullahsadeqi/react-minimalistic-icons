...
export interface ShoppingBagOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ShoppingBagOutline: React.FC<ShoppingBagOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
