...
export interface BagTimerTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BagTimerTwotone: React.FC<BagTimerTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M12.25 13.75V14.68C12.25 15.03 12.07 15.36 11.76 15.54L11 16" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
