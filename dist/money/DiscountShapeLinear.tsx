...
export interface DiscountShapeLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DiscountShapeLinear: React.FC<DiscountShapeLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
