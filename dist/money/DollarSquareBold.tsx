...
export interface DollarSquareBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DollarSquareBold: React.FC<DollarSquareBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M11.2499 8.08002V10.94L10.2399 10.59C9.72992 10.41 9.41992 10.24 9.41992 9.37002C9.41992 8.66002 9.94992 8.08002 10.5999 8.08002H11.2499Z" fill={color}/>
<path d="M14.58 14.63C14.58 15.34 14.05 15.92 13.4 15.92H12.75V13.06L13.76 13.41C14.27 13.59 14.58 13.76 14.58 14.63Z" fill={color}/>
