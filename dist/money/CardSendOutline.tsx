...
export interface CardSendOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardSendOutline: React.FC<CardSendOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M20 10.25C19.59 10.25 19.25 9.91 19.25 9.5V3.5C19.25 3.2 19.43 2.92 19.71 2.81C19.99 2.7 20.31 2.76 20.53 2.97L22.53 4.97C22.82 5.26 22.82 5.74 22.53 6.03C22.24 6.32 21.76 6.32 21.47 6.03L20.75 5.31V9.5C20.75 9.91 20.41 10.25 20 10.25Z" fill={color}/>
<path d="M17.9999 6.25C17.8099 6.25 17.6199 6.18 17.4699 6.03C17.1799 5.74 17.1799 5.26 17.4699 4.97L19.4699 2.97C19.7599 2.68 20.2399 2.68 20.5299 2.97C20.8199 3.26 20.8199 3.74 20.5299 4.03L18.5299 6.03C18.3799 6.18 18.1899 6.25 17.9999 6.25Z" fill={color}/>
</svg>
