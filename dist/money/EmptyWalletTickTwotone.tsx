...
export interface EmptyWalletTickTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const EmptyWalletTickTwotone: React.FC<EmptyWalletTickTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M3.43994 19L4.42993 19.99L6.55994 18.02" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
