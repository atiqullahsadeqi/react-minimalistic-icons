...
export interface CardBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardBold: React.FC<CardBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 7.55002C22 8.21002 21.46 8.75002 20.8 8.75002H3.2C2.54 8.75002 2 8.21002 2 7.55002V7.54002C2 5.25002 3.85 3.40002 6.14 3.40002H17.85C20.14 3.40002 22 5.26002 22 7.55002Z" fill={color}/>
