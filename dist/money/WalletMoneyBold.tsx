...
export interface WalletMoneyBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const WalletMoneyBold: React.FC<WalletMoneyBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 10.97V13.03C22 13.58 21.56 14.03 21 14.05H19.04C17.96 14.05 16.97 13.26 16.88 12.18C16.82 11.55 17.06 10.96 17.48 10.55C17.85 10.17 18.36 9.94995 18.92 9.94995H21C21.56 9.96995 22 10.42 22 10.97Z" fill={color}/>
</svg>
