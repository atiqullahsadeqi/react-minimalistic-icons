...
export interface EmptyWalletChangeLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const EmptyWalletChangeLinear: React.FC<EmptyWalletChangeLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2.5 12.4101V7.8401C2.5 6.6501 3.23 5.59006 4.34 5.17006L12.28 2.17006C13.52 1.70006 14.85 2.62009 14.85 3.95009V7.75008" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
