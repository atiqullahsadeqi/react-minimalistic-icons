...
export interface TicketTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TicketTwotone: React.FC<TicketTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M10 4L10 20" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" stroke-dasharray="5 5"/>
</svg>
