...
export interface WalletCheckTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const WalletCheckTwotone: React.FC<WalletCheckTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M3.43994 19L4.42994 19.99L6.55994 18.02" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path opacity="0.4" d="M17.7499 7.04997C17.5099 7.00997 17.2599 6.99998 16.9999 6.99998H6.99994C6.71994 6.99998 6.44994 7.01998 6.18994 7.05998C6.32994 6.77998 6.52994 6.52001 6.76994 6.28001L10.0199 3.02C11.3899 1.66 13.6099 1.66 14.9799 3.02L16.7299 4.78996C17.3699 5.41996 17.7099 6.21997 17.7499 7.04997Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
