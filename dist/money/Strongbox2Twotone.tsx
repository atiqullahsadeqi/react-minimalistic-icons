...
export interface Strongbox2TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Strongbox2Twotone: React.FC<Strongbox2TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M7.2002 12H7.3002" stroke={color} strokeWidth="2" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
