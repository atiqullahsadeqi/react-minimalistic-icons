...
export interface MoneyForbiddenBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MoneyForbiddenBulk: React.FC<MoneyForbiddenBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M1.70001 20.24C1.71001 20.23 1.71002 20.22 1.71002 20.22L7.21002 14.72C7.22002 14.71 7.22999 14.71 7.23999 14.7C6.59999 14.26 5.81999 14 4.98999 14C2.77999 14 0.98999 15.79 0.98999 18C0.98999 18.75 1.20001 19.46 1.57001 20.06C1.62001 20.12 1.66001 20.18 1.70001 20.24Z" fill={color}/>
