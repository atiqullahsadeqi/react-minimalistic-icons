...
export interface TicketExpiredTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TicketExpiredTwotone: React.FC<TicketExpiredTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.9023 19.8701H17.3723C21.0723 19.8701 21.9923 18.9501 21.9923 15.2501C20.7123 15.2501 19.6823 14.2101 19.6823 12.9401C19.6823 11.6601 20.7123 10.6201 21.9923 10.6201V9.70008C21.9923 6.00008 21.0723 5.08008 17.3723 5.08008H10.9923V11.8701" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
