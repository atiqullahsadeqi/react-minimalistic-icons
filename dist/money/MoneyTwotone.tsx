...
export interface MoneyTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MoneyTwotone: React.FC<MoneyTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M5.5 9.5V14.5" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
