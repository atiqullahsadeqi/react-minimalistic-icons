...
export interface TicketDiscountBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TicketDiscountBold: React.FC<TicketDiscountBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
