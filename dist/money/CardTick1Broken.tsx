...
export interface CardTick1BrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardTick1Broken: React.FC<CardTick1BrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M6 10H22" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
