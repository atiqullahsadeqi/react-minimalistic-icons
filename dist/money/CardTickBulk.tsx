...
export interface CardTickBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardTickBulk: React.FC<CardTickBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M22 7.77002V9.00002H2V7.54002C2 5.25002 3.86 3.40002 6.15 3.40002H16V5.97002C16 7.24002 16.76 8.00002 18.03 8.00002H20.97C21.37 8.00002 21.71 7.93002 22 7.77002Z" fill={color}/>
