...
export interface EmptyWalletChangeTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const EmptyWalletChangeTwotone: React.FC<EmptyWalletChangeTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M9.5 21.7801H4.16C3.52 21.7801 3 21.2601 3 20.6201V19.3401" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M8.28003 23.0001L9.50003 21.7801L8.28003 20.5601" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

  );
};

export default EmptyWalletChangeTwotone;
