...
export interface TicketBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TicketBroken: React.FC<TicketBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10 4L10 20" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" stroke-dasharray="5 5"/>
</svg>
