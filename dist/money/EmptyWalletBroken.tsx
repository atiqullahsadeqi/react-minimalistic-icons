...
export interface EmptyWalletBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const EmptyWalletBroken: React.FC<EmptyWalletBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2.5 14.07V11.51C2.5 9.44001 4.19 7.75 6.26 7.75H17.74C19.81 7.75 21.5 9.44001 21.5 11.51V12.95H19.48C18.92 12.95 18.41 13.17 18.04 13.55C17.62 13.96 17.38 14.55 17.44 15.18C17.53 16.26 18.52 17.05 19.6 17.05H21.5V18.24C21.5 20.31 19.81 22 17.74 22H6.26C4.19 22 2.5 20.31 2.5 18.24" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
