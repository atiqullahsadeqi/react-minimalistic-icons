...
export interface CardTick1BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardTick1Bold: React.FC<CardTick1BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 7.55002V8.00002C22 8.55002 21.55 9.00002 21 9.00002H3C2.45 9.00002 2 8.55002 2 8.00002V7.54002C2 5.25002 3.85 3.40002 6.14 3.40002H17.85C20.14 3.40002 22 5.26002 22 7.55002Z" fill={color}/>
