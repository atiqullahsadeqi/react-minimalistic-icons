...
export interface TagLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TagLinear: React.FC<TagLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M9.5 12.0001C10.8807 12.0001 12 10.8808 12 9.50006C12 8.11935 10.8807 7.00006 9.5 7.00006C8.11929 7.00006 7 8.11935 7 9.50006C7 10.8808 8.11929 12.0001 9.5 12.0001Z" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
</svg>
