...
export interface CardAddBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardAddBroken: React.FC<CardAddBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 12.03V16.11C22 19.62 21.11 20.5 17.56 20.5H6.44C2.89 20.5 2 19.62 2 16.11V15.04" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
