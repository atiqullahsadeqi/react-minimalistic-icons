...
export interface TicketOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TicketOutline: React.FC<TicketOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10 14.58C9.59 14.58 9.25 14.24 9.25 13.83V10.16C9.25 9.74997 9.59 9.40997 10 9.40997C10.41 9.40997 10.75 9.74997 10.75 10.16V13.83C10.75 14.25 10.41 14.58 10 14.58Z" fill={color}/>
