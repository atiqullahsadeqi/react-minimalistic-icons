...
export interface CardTick1BulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardTick1Bulk: React.FC<CardTick1BulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 7.54002V9.00002H2V7.54002C2 5.25002 3.86002 3.40002 6.15002 3.40002H17.85C20.14 3.40002 22 5.25002 22 7.54002Z" fill={color}/>
