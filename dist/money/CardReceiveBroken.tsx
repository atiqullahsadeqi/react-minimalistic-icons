...
export interface CardReceiveBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardReceiveBroken: React.FC<CardReceiveBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2 11.06V7.89C2 4.38 2.89 3.5 6.44 3.5H14.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M22 14.03V16.11C22 19.62 21.11 20.5 17.56 20.5H6.44C2.89 20.5 2 19.62 2 16.11V15.03" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
