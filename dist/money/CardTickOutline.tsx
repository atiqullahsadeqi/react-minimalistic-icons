...
export interface CardTickOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardTickOutline: React.FC<CardTickOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M17.9999 8.25C17.8099 8.25 17.6199 8.18 17.4699 8.03L15.9699 6.53C15.6799 6.24 15.6799 5.76 15.9699 5.47C16.2599 5.18 16.7399 5.18 17.0299 5.47L17.9999 6.44L21.4699 2.97C21.7599 2.68 22.2399 2.68 22.5299 2.97C22.8199 3.26 22.8199 3.74 22.5299 4.03L18.5299 8.03C18.3799 8.18 18.1899 8.25 17.9999 8.25Z" fill={color}/>
</svg>
