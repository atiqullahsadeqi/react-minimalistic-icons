...
export interface EmptyWalletRemoveBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const EmptyWalletRemoveBroken: React.FC<EmptyWalletRemoveBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M6.07019 20.04L3.9502 17.93" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M6.05017 17.96L3.93018 20.07" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
