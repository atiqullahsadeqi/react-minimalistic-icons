...
export interface BriefcaseTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BriefcaseTwotone: React.FC<BriefcaseTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2.61914 11.2695C4.86914 12.8095 7.40914 13.7395 9.99914 14.0295" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
