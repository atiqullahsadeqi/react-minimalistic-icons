...
export interface BrifecaseTickTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BrifecaseTickTwotone: React.FC<BrifecaseTickTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M10.4399 14.2999L11.0899 14.9499C11.2799 15.1399 11.5899 15.1399 11.7799 14.9599L13.5599 13.3199" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
