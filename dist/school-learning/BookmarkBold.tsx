...
export interface BookmarkBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BookmarkBold: React.FC<BookmarkBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
