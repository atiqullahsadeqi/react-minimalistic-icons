...
export interface TeacherBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TeacherBold: React.FC<TeacherBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
