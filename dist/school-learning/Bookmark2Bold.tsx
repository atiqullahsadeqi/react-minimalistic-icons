...
export interface Bookmark2BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Bookmark2Bold: React.FC<Bookmark2BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
