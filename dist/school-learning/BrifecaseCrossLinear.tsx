...
export interface BrifecaseCrossLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BrifecaseCrossLinear: React.FC<BrifecaseCrossLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12 18.2C14.2091 18.2 16 16.4092 16 14.2C16 11.9909 14.2091 10.2 12 10.2C9.79086 10.2 8 11.9909 8 14.2C8 16.4092 9.79086 18.2 12 18.2Z" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
