...
export interface Book1BrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Book1Broken: React.FC<Book1BrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
