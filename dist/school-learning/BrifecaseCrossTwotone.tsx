...
export interface BrifecaseCrossTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BrifecaseCrossTwotone: React.FC<BrifecaseCrossTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M13.0692 15.3102L10.9492 13.2002" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M13.0497 13.2197L10.9297 15.3397" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</g>
