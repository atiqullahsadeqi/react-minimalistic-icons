...
export interface AwardLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const AwardLinear: React.FC<AwardLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
