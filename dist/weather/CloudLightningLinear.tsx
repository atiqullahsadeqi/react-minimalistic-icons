...
export interface CloudLightningLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudLightningLinear: React.FC<CloudLightningLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M9.22995 19.16H10.23V21.49C10.23 21.83 10.66 22 10.88 21.74L13.33 18.95C13.63 18.61 13.5 18.33 13.05 18.33H12.05V16C12.05 15.66 11.62 15.49 11.4 15.75L8.94995 18.54C8.64995 18.88 8.77995 19.16 9.22995 19.16Z" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
