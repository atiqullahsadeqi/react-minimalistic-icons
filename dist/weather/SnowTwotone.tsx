...
export interface SnowTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SnowTwotone: React.FC<SnowTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.7898 16.5L15.0298 13.75" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M19.7898 7.5L15.0298 10.25" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
