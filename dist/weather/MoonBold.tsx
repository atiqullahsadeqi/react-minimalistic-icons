...
export interface MoonBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MoonBold: React.FC<MoonBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
