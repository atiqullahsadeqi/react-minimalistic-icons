...
export interface CloudCrossTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudCrossTwotone: React.FC<CloudCrossTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M12.3905 18.5898L9.56055 21.4098" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12.3905 21.4098L9.56055 18.5898" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
