...
export interface CloudFogBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudFogBulk: React.FC<CloudFogBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.8 12H4.19999C3.97999 12 3.78 11.85 3.71 11.64C0.959996 2.55003 14.84 -0.939963 16.44 8.82004C18.1 9.03004 19.4099 9.97003 20.2199 11.23C20.4399 11.56 20.19 12 19.8 12Z" fill={color}/>
