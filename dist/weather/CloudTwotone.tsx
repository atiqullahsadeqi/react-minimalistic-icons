...
export interface CloudTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudTwotone: React.FC<CloudTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
