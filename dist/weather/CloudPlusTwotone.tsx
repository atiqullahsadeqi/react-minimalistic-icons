...
export interface CloudPlusTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudPlusTwotone: React.FC<CloudPlusTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M12.9707 20H8.9707" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M10.9707 22V18" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
