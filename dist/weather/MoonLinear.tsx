...
export interface MoonLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MoonLinear: React.FC<MoonLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
