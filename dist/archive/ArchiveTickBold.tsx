...
export interface ArchiveTickBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArchiveTickBold: React.FC<ArchiveTickBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
