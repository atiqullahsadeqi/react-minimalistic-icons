...
export interface ArchiveSlashBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArchiveSlashBold: React.FC<ArchiveSlashBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.29 7.71005L11.9 15.1001C11.44 15.5601 11.53 16.3301 12.09 16.6601L19.48 21.0901C20.15 21.4901 20.99 21.0101 20.99 20.2301V8.41005C21 7.52005 19.92 7.08005 19.29 7.71005Z" fill={color}/>
</svg>
