...
export interface BookSquareTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BookSquareTwotone: React.FC<BookSquareTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12 8.1001V17.6601" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
