...
export interface ArchiveMinusOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArchiveMinusOutline: React.FC<ArchiveMinusOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
