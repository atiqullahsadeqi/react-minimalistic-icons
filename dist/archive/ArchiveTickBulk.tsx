...
export interface ArchiveTickBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArchiveTickBulk: React.FC<ArchiveTickBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
