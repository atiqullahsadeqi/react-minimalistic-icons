...
export interface MobileProgrammingBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MobileProgrammingBroken: React.FC<MobileProgrammingBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M3 12.98V7C3 4 4.5 2 8 2H16C19.5 2 21 4 21 7V14" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M13 22H8C4.5 22 3 20 3 17" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
