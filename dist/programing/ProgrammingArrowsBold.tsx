...
export interface ProgrammingArrowsBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ProgrammingArrowsBold: React.FC<ProgrammingArrowsBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
