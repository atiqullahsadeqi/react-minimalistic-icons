...
export interface SidebarBottomBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SidebarBottomBold: React.FC<SidebarBottomBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M3.05002 19.87C3.34002 20.29 3.71002 20.66 4.13002 20.95C5.08002 21.64 6.32002 22 7.81002 22H16.19C19.63 22 21.76 20.06 21.97 16.78H2.02002C2.10002 18.01 2.45002 19.05 3.05002 19.87Z" fill={color}/>
