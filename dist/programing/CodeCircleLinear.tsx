...
export interface CodeCircleLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CodeCircleLinear: React.FC<CodeCircleLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M13 9.66998L11 14.33" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
