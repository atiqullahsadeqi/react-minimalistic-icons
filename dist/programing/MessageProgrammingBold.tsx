...
export interface MessageProgrammingBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MessageProgrammingBold: React.FC<MessageProgrammingBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
