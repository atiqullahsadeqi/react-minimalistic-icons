...
export interface MobileProgrammingBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MobileProgrammingBulk: React.FC<MobileProgrammingBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M14.9999 2V3.5C14.9999 4.32 14.3199 5 13.4999 5H10.4699C9.65994 5 8.98994 4.34003 8.96994 3.53003L8.92993 2H14.9999Z" fill={color}/>
</svg>
