...
export interface CloudConnectionBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudConnectionBulk: React.FC<CloudConnectionBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M19.2 14.78C18.34 15.57 17.2 16.01 16.03 16H6.37C2.3 15.71 2.29 9.80002 6.37 9.51002H6.41001C3.62001 1.75002 15.41 -1.34 16.76 6.8C20.53 7.28 22.06 12.29 19.2 14.78Z" fill={color}/>
