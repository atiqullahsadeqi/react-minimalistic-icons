...
export interface PrinterSlashBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PrinterSlashBroken: React.FC<PrinterSlashBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M21 14V15C21 17 20 18 18 18H16V15H13" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19.97 7.52C20.66 8 21 8.83 21 10" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
