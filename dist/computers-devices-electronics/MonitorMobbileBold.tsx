...
export interface MonitorMobbileBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MonitorMobbileBold: React.FC<MonitorMobbileBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M20.99 6.19V7C20.99 7.55 20.54 8 19.99 8H14.36C11.8 8 10.5 9.31 10.5 11.88V21C10.5 21.55 10.05 22 9.50001 22H7.55001C7.15001 22 6.83001 21.68 6.83001 21.29C6.83001 20.89 7.15001 20.58 7.55001 20.58H9.50001V16.75H6.00001C3.78001 16.64 2.01001 14.81 2.01001 12.56V6.19C2.01001 3.88 3.89001 2 6.21001 2H16.8C19.11 2 20.99 3.88 20.99 6.19Z" fill={color}/>
</svg>
