...
export interface CloudRemoveBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudRemoveBulk: React.FC<CloudRemoveBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
