...
export interface MonitorMobbileBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MonitorMobbileBulk: React.FC<MonitorMobbileBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.64 9.5H14.35C12.62 9.5 11.99 10.13 11.99 11.88V19.61C11.99 21.37 12.61 21.99 14.35 21.99H19.64C21.37 21.99 22 21.36 22 19.61V11.88C22 10.12 21.38 9.5 19.64 9.5ZM17 20.32C16.39 20.32 15.9 19.83 15.9 19.22C15.9 18.61 16.39 18.12 17 18.12C17.61 18.12 18.1 18.61 18.1 19.22C18.1 19.83 17.61 20.32 17 20.32Z" fill={color}/>
<path opacity="0.4" d="M18.1 19.22C18.1 19.83 17.61 20.32 17 20.32C16.39 20.32 15.9 19.83 15.9 19.22C15.9 18.61 16.39 18.12 17 18.12C17.61 18.12 18.1 18.62 18.1 19.22Z" fill={color}/>
</svg>
