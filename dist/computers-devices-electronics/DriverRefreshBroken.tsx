...
export interface DriverRefreshBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DriverRefreshBroken: React.FC<DriverRefreshBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2 12H18" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
