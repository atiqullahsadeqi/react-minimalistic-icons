...
export interface CloudRemoveBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudRemoveBroken: React.FC<CloudRemoveBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M5.54 11.12C0.859999 11.45 0.859999 18.26 5.54 18.59H7.46" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M5.59 11.12C3.06 4.08999 10.92 0.379997 15.13 3.7" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
