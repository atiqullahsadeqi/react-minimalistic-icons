...
export interface CloudConnectionBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudConnectionBold: React.FC<CloudConnectionBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.2 14.78C18.34 15.57 17.2 16.01 16.03 16H6.37C2.3 15.71 2.29 9.8 6.37 9.51H6.41C3.62 1.75 15.41 -1.34 16.76 6.8C20.53 7.28 22.06 12.29 19.2 14.78Z" fill={color}/>
