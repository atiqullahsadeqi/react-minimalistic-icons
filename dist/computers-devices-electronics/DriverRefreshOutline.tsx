...
export interface DriverRefreshOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DriverRefreshOutline: React.FC<DriverRefreshOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
