...
export interface AirpodsBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const AirpodsBold: React.FC<AirpodsBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
