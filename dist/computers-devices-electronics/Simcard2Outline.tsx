...
export interface Simcard2OutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Simcard2Outline: React.FC<Simcard2OutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12.11 22.72H5.89C3.16 22.72 1.25 20.81 1.25 18.08V10.31C1.25 7.58001 3.16 5.67001 5.89 5.67001H9.72C10.94 5.67001 12.14 6.17001 13 7.03001L15.39 9.41001C16.26 10.28 16.75 11.47 16.75 12.69V18.08C16.75 20.81 14.84 22.72 12.11 22.72ZM5.89 7.17001C3.98 7.17001 2.75 8.40001 2.75 10.31V18.08C2.75 19.99 3.98 21.22 5.89 21.22H12.11C14.02 21.22 15.25 19.99 15.25 18.08V12.69C15.25 11.86 14.91 11.06 14.33 10.47L11.94 8.09001C11.35 7.50001 10.54 7.17001 9.72 7.17001H5.89Z" fill={color}/>
