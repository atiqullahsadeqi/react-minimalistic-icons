...
export interface PrinterSlashBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PrinterSlashBulk: React.FC<PrinterSlashBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M21 10V15C21 17 20 18 18 18H16V15H12L19.67 7.33C20.56 7.78 21 8.67 21 10Z" fill={color}/>
</svg>
