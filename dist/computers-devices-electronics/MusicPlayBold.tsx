...
export interface MusicPlayBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MusicPlayBold: React.FC<MusicPlayBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
