...
export interface BluetoothRectangleBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BluetoothRectangleBold: React.FC<BluetoothRectangleBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12.9 16.33L14.57 14.94L12.9 13.41V16.33Z" fill={color}/>
<path d="M12.9 10.59L14.57 9.06L12.9 7.67V10.59Z" fill={color}/>
