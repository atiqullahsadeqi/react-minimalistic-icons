...
export interface CloudRemoveLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CloudRemoveLinear: React.FC<CloudRemoveLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M5.59 11.12C2.38 2.18999 15.92 -1.38001 17.47 7.99999C21.8 8.54999 23.55 14.32 20.27 17.19C19.27 18.1 17.98 18.6 16.63 18.59H16.54" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
