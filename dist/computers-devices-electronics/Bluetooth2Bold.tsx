...
export interface Bluetooth2BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Bluetooth2Bold: React.FC<Bluetooth2BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12.3 17.32L14.61 15.39L12.3 13.3V17.32Z" fill={color}/>
<path d="M12.3 6.67999V10.64L14.61 8.51999L12.3 6.67999Z" fill={color}/>
