...
export interface RamBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const RamBroken: React.FC<RamBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M13.97 7.78H7.96997" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
