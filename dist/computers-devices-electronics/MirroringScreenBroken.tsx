...
export interface MirroringScreenBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MirroringScreenBroken: React.FC<MirroringScreenBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 12.45V16C22 19 20 21 17 21H16" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M2 9V8C2 5 4 3 7 3H17C20 3 22 5 22 8" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
