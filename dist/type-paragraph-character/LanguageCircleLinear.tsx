...
export interface LanguageCircleLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LanguageCircleLinear: React.FC<LanguageCircleLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M16.99 8.95996H7.01001" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
