...
export interface LinkTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LinkTwotone: React.FC<LinkTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M8 12H16" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
