...
export interface TextItalicTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TextItalicTwotone: React.FC<TextItalicTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M14.25 3L9.75 21" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
