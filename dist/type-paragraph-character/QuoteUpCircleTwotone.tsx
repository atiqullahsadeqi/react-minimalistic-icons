...
export interface QuoteUpCircleTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const QuoteUpCircleTwotone: React.FC<QuoteUpCircleTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.8602 11.84H8.18022C7.47022 11.84 6.99023 11.3 6.99023 10.65V9.15997C6.99023 8.50997 7.47022 7.96997 8.18022 7.96997H9.67023C10.3202 7.96997 10.8602 8.50997 10.8602 9.15997V11.84Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
