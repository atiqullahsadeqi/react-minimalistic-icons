...
export interface LanguageCircleTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LanguageCircleTwotone: React.FC<LanguageCircleTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M16.9897 8.95996H7.00977" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12 7.28003V8.96002" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M14.5 8.93994C14.5 13.2399 11.14 16.7199 7 16.7199" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
