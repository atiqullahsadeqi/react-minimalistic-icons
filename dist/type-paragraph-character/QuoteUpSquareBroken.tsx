...
export interface QuoteUpSquareBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const QuoteUpSquareBroken: React.FC<QuoteUpSquareBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.86 11.84H8.17999C7.46999 11.84 6.98999 11.3 6.98999 10.65V9.15997C6.98999 8.50997 7.46999 7.96997 8.17999 7.96997H9.66999C10.32 7.96997 10.86 8.50997 10.86 9.15997V11.84Z" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
