...
export interface TextalignCenterBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TextalignCenterBroken: React.FC<TextalignCenterBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.05 4.5H21" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M3 4.5H5.98" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
