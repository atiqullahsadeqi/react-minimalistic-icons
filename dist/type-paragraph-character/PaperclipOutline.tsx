...
export interface PaperclipOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PaperclipOutline: React.FC<PaperclipOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
