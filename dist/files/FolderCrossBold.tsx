...
export interface FolderCrossBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FolderCrossBold: React.FC<FolderCrossBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
