...
export interface FolderCloudBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FolderCloudBold: React.FC<FolderCloudBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M15.5801 19.7C13.4701 19.85 13.4701 22.91 15.5801 23.06H20.5901C21.2001 23.06 21.7801 22.84 22.2301 22.43C23.7101 21.14 22.9201 18.54 20.9701 18.3C20.2701 14.08 14.1601 15.68 15.6101 19.7" fill={color}/>
<path d="M15.5801 19.7C13.4701 19.85 13.4701 22.91 15.5801 23.06H20.5901C21.2001 23.06 21.7801 22.84 22.2301 22.43C23.7101 21.14 22.9201 18.54 20.9701 18.3C20.2701 14.08 14.1601 15.68 15.6101 19.7" fill={color}/>
