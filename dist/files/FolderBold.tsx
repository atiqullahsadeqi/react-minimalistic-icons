...
export interface FolderBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FolderBold: React.FC<FolderBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M20.9834 10.7498C21.5343 10.7498 21.9815 11.1954 21.9834 11.7464L22 16.65C22 19.6 19.6 22 16.65 22H7.35C4.4 22 2 19.6 2 16.65V11.75C2 11.1977 2.44771 10.75 2.99999 10.75L20.9834 10.7498Z" fill={color}/>
</svg>
