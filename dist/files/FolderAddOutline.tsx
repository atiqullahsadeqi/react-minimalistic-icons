...
const FolderAddOutline: React.FC<FolderAddOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12.0601 17.25C11.6501 17.25 11.3101 16.91 11.3101 16.5V11.5C11.3101 11.09 11.6501 10.75 12.0601 10.75C12.4701 10.75 12.8101 11.09 12.8101 11.5V16.5C12.8101 16.91 12.4701 17.25 12.0601 17.25Z" fill={color}/>
