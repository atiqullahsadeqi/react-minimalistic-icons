...
export interface VideoRemoveLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoRemoveLinear: React.FC<VideoRemoveLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.7001 19.6801L17.3201 17.3" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
