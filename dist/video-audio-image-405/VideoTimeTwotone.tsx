...
export interface VideoTimeTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoTimeTwotone: React.FC<VideoTimeTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
