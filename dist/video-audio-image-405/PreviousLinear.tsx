...
export interface PreviousLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PreviousLinear: React.FC<PreviousLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M3.76001 18.1803V5.82031" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
