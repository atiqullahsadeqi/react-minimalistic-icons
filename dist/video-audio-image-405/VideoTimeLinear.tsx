...
export interface VideoTimeLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoTimeLinear: React.FC<VideoTimeLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M18.78 17.0901V18.7801L17.38 19.6201" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
