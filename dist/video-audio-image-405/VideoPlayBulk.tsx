...
export interface VideoPlayBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoPlayBulk: React.FC<VideoPlayBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M14.44 12.72L12.36 11.52C11.59 11.08 10.85 11.02 10.27 11.35C9.69 11.68 9.37 12.36 9.37 13.24V15.64C9.37 16.52 9.69 17.2 10.27 17.53C10.52 17.67 10.8 17.74 11.09 17.74C11.49 17.74 11.92 17.61 12.36 17.36L14.44 16.16C15.21 15.72 15.63 15.1 15.63 14.43C15.63 13.76 15.2 13.17 14.44 12.72Z" fill={color}/>
</svg>
