...
export interface Microphone2LinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Microphone2Linear: React.FC<Microphone2LinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M4.34998 9.6499V11.3499C4.34998 15.5699 7.77998 18.9999 12 18.9999C16.22 18.9999 19.65 15.5699 19.65 11.3499V9.6499" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M10.61 6.43012C11.51 6.10012 12.49 6.10012 13.39 6.43012" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
