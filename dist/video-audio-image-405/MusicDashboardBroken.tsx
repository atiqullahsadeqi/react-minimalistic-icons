...
export interface MusicDashboardBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MusicDashboardBroken: React.FC<MusicDashboardBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2 9C2 4 4 2 9 2H15C20 2 22 4 22 9V15C22 20 20 22 15 22H9C4 22 2 20 2 15V13.59" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
