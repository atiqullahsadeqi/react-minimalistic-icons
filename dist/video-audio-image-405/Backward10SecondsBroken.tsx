...
export interface Backward10SecondsBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Backward10SecondsBroken: React.FC<Backward10SecondsBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M4.91 7.80005C3.8 9.28005 3.10999 11.11 3.10999 13.11" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
