...
export interface VideoAddLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoAddLinear: React.FC<VideoAddLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M20.1801 18.48H16.8201" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M18.5 16.8401V20.2001" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
