...
export interface VideoTickLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoTickLinear: React.FC<VideoTickLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M16.75 18.5L17.86 19.61L20.26 17.39" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
