...
export interface Microphone2TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Microphone2Twotone: React.FC<Microphone2TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M10.61 6.43012C11.51 6.10012 12.49 6.10012 13.39 6.43012" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path opacity="0.4" d="M11.2 8.55007C11.73 8.41007 12.28 8.41007 12.81 8.55007" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<g opacity="0.4">
