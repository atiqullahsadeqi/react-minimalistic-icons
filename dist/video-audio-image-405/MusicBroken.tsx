...
export interface MusicBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MusicBroken: React.FC<MusicBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M20.84 7.95997V4.59997C20.84 1.99997 19.21 1.63997 17.56 2.08997L11.32 3.78997C10.18 4.09997 9.39999 4.99997 9.39999 6.29997V8.46997V9.92997V18.87" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M20.84 16.8V12" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
