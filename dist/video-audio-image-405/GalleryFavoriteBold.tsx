...
export interface GalleryFavoriteBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const GalleryFavoriteBold: React.FC<GalleryFavoriteBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
