...
export interface VideoPlayBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoPlayBold: React.FC<VideoPlayBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
