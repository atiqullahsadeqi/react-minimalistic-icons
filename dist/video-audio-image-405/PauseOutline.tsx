...
export interface PauseOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PauseOutline: React.FC<PauseOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
