...
export interface VideoAddTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoAddTwotone: React.FC<VideoAddTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M20.1801 18.4802H16.8201" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M18.4998 16.8401V20.2001" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
