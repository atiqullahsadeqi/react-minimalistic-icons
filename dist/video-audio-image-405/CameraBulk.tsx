...
export interface CameraBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CameraBulk: React.FC<CameraBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12 18.1301C13.8667 18.1301 15.38 16.6168 15.38 14.7501C15.38 12.8834 13.8667 11.3701 12 11.3701C10.1333 11.3701 8.62 12.8834 8.62 14.7501C8.62 16.6168 10.1333 18.1301 12 18.1301Z" fill={color}/>
</svg>
