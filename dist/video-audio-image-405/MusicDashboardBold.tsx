...
export interface MusicDashboardBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MusicDashboardBold: React.FC<MusicDashboardBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M7 3.25007V20.7501C7 21.3901 6.39 21.9001 5.77 21.7301C3.37 21.0501 2 19.0901 2 16.1901V7.81007C2 4.91007 3.37 2.95007 5.77 2.27007C6.39 2.10007 7 2.60007 7 3.25007Z" fill={color}/>
<path d="M12.47 14.3701C12.09 14.3701 11.79 14.6801 11.79 15.0501C11.79 15.4201 12.1 15.7301 12.47 15.7301C12.85 15.7301 13.16 15.4201 13.16 15.0501C13.16 14.6801 12.85 14.3701 12.47 14.3701Z" fill={color}/>
<path d="M17.52 13.45C17.14 13.45 16.83 13.76 16.83 14.14C16.83 14.52 17.14 14.82 17.52 14.82C17.9 14.82 18.21 14.51 18.21 14.14C18.21 13.77 17.9 13.45 17.52 13.45Z" fill={color}/>
