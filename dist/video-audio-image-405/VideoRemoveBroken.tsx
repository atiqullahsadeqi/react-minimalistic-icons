...
export interface VideoRemoveBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoRemoveBroken: React.FC<VideoRemoveBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
