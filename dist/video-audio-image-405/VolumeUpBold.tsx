...
export interface VolumeUpBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VolumeUpBold: React.FC<VolumeUpBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
