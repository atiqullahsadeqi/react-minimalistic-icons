...
export interface VideoRemoveTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const VideoRemoveTwotone: React.FC<VideoRemoveTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
