...
export interface MicrophoneSlash2LinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MicrophoneSlash2Linear: React.FC<MicrophoneSlash2LinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M6.78003 16.9499C8.15003 18.2199 9.98003 18.9999 12 18.9999C16.22 18.9999 19.65 15.5699 19.65 11.3499V9.6499" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
export default MicrophoneSlash2Linear;
