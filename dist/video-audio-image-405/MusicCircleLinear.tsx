...
export interface MusicCircleLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MusicCircleLinear: React.FC<MusicCircleLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M5.72003 19.7502C5.25003 19.3702 4.80002 18.9502 4.40002 18.4902" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
