...
export interface LovelyTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LovelyTwotone: React.FC<LovelyTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
