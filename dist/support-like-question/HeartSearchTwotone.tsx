...
export interface HeartSearchTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HeartSearchTwotone: React.FC<HeartSearchTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
