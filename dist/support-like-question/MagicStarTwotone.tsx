...
export interface MagicStarTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MagicStarTwotone: React.FC<MagicStarTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
