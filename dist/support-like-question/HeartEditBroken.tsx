...
export interface HeartEditBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HeartEditBroken: React.FC<HeartEditBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12 20.9003C11.78 20.9003 11.55 20.8702 11.38 20.8102C8.48 19.8202 2 15.6902 2 8.69025C2 7.29025 2.51 6.01027 3.36 5.03027" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
