...
export interface UnlimitedTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const UnlimitedTwotone: React.FC<UnlimitedTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
