...
export interface HeartEditBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HeartEditBold: React.FC<HeartEditBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
