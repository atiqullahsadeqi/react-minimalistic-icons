...
export interface MaximizeOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MaximizeOutline: React.FC<MaximizeOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12.9999 11.75C12.8099 11.75 12.6199 11.68 12.4699 11.53C12.1799 11.24 12.1799 10.76 12.4699 10.47L16.2099 6.72H13.9999C13.5899 6.72 13.2499 6.38 13.2499 5.97C13.2499 5.56 13.5799 5.22 13.9999 5.22H18.0099C18.3099 5.22 18.5899 5.4 18.6999 5.68C18.8199 5.96 18.7499 6.28 18.5399 6.5L13.5299 11.53C13.3799 11.68 13.1899 11.75 12.9999 11.75Z" fill={color}/>
<path d="M18.01 10.74C17.6 10.74 17.26 10.4 17.26 9.99V5.97C17.26 5.56 17.6 5.22 18.01 5.22C18.42 5.22 18.76 5.56 18.76 5.97V9.98C18.76 10.4 18.42 10.74 18.01 10.74Z" fill={color}/>
<path d="M7.85 22.75H5.15C2.49 22.75 1.25 21.51 1.25 18.85V16.15C1.25 13.49 2.49 12.25 5.15 12.25H7.85C10.51 12.25 11.75 13.49 11.75 16.15V18.85C11.75 21.51 10.51 22.75 7.85 22.75ZM5.15 13.75C3.31 13.75 2.75 14.31 2.75 16.15V18.85C2.75 20.69 3.31 21.25 5.15 21.25H7.85C9.69 21.25 10.25 20.69 10.25 18.85V16.15C10.25 14.31 9.69 13.75 7.85 13.75H5.15Z" fill={color}/>
</svg>
