...
export interface Maximize4BulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Maximize4Bulk: React.FC<Maximize4BulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M18.6899 5.71C18.6099 5.53 18.4699 5.38 18.2799 5.3C18.1899 5.27 18.0999 5.25 17.9999 5.25H13.9999C13.5899 5.25 13.2499 5.59 13.2499 6C13.2499 6.41 13.5899 6.75 13.9999 6.75H16.1899L12.4699 10.47C12.1799 10.76 12.1799 11.24 12.4699 11.53C12.6199 11.68 12.8099 11.75 12.9999 11.75C13.1899 11.75 13.3799 11.68 13.5299 11.53L17.2499 7.81V10C17.2499 10.41 17.5899 10.75 17.9999 10.75C18.4099 10.75 18.7499 10.41 18.7499 10V6C18.7499 5.9 18.7299 5.81 18.6899 5.71Z" fill={color}/>
