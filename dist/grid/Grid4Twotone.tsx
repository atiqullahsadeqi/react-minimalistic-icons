...
export interface Grid4TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Grid4Twotone: React.FC<Grid4TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M9 2V22" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
