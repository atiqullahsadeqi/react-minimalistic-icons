...
export interface Grid6TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Grid6Twotone: React.FC<Grid6TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10 8.5H22" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M10 15.5H22" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
