...
export interface AlignHorizontallyOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const AlignHorizontallyOutline: React.FC<AlignHorizontallyOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 12.75H19.3C18.89 12.75 18.55 12.41 18.55 12C18.55 11.59 18.89 11.25 19.3 11.25H22C22.41 11.25 22.75 11.59 22.75 12C22.75 12.41 22.42 12.75 22 12.75Z" fill={color}/>
</svg>
