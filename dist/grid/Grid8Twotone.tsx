...
export interface Grid8TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Grid8Twotone: React.FC<Grid8TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M8.25 12V21.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M15.75 12V2.54004" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
