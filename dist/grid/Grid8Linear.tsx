...
export interface Grid8LinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Grid8Linear: React.FC<Grid8LinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M15.75 12V2.53999" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
