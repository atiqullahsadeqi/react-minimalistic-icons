...
export interface AlignRightOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const AlignRightOutline: React.FC<AlignRightOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19 22.74C18.59 22.74 18.25 22.4 18.25 21.99V1.98999C18.25 1.57999 18.59 1.23999 19 1.23999C19.41 1.23999 19.75 1.57999 19.75 1.98999V21.99C19.75 22.4 19.41 22.74 19 22.74Z" fill={color}/>
</svg>
