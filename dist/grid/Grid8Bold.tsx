...
export interface Grid8BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Grid8Bold: React.FC<Grid8BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 7.81V11.25H16.75V2.03C20.05 2.23 22 4.36 22 7.81Z" fill={color}/>
...
<path d="M7.25 2.03V11.25H2V7.81C2 4.36 3.95 2.23 7.25 2.03Z" fill={color}/>
