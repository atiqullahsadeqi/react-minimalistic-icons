...
export interface 3dCubeScanBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const 3dCubeScanBroken: React.FC<3dCubeScanBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
