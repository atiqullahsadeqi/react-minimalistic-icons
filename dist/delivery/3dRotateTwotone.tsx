...
export interface 3dRotateTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const 3dRotateTwotone: React.FC<3dRotateTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
export default 3dRotateTwotone;
