...
export interface 3dCubeScanTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const 3dCubeScanTwotone: React.FC<3dCubeScanTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
export default 3dCubeScanTwotone;
