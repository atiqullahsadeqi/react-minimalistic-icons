...
export interface Export4BrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Export4Broken: React.FC<Export4BrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2 12.99V15C2 20 4 22 9 22H15C20 22 22 20 22 15V13" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
