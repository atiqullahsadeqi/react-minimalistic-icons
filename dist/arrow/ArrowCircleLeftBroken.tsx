...
export interface ArrowCircleLeftBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArrowCircleLeftBroken: React.FC<ArrowCircleLeftBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M13.26 15.53L9.73999 12L10.7 11.03L12.9 8.82997L13.26 8.46997" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
