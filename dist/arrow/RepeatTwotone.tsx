...
export interface RepeatTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const RepeatTwotone: React.FC<RepeatTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M3.58008 5.15997H17.4201C19.0801 5.15997 20.4201 6.49997 20.4201 8.15997V11.48" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
