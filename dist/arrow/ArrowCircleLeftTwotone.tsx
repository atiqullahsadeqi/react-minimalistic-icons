...
export interface ArrowCircleLeftTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArrowCircleLeftTwotone: React.FC<ArrowCircleLeftTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M13.26 15.53L9.73999 12L13.26 8.46997" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
