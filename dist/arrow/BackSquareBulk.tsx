...
export interface BackSquareBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BackSquareBulk: React.FC<BackSquareBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
