...
export interface ArrowRightBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArrowRightBulk: React.FC<ArrowRightBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
