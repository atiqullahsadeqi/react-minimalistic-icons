...
export interface Arrow3BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Arrow3Bold: React.FC<Arrow3BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
