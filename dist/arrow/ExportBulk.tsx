...
export interface ExportBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ExportBulk: React.FC<ExportBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
