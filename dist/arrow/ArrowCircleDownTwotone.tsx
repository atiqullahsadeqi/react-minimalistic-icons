...
export interface ArrowCircleDownTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArrowCircleDownTwotone: React.FC<ArrowCircleDownTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M8.46997 10.74L12 14.26L15.53 10.74" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
