...
export interface ArrowBottomOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArrowBottomOutline: React.FC<ArrowBottomOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
