...
export interface ReceiveSquare2TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ReceiveSquare2Twotone: React.FC<ReceiveSquare2TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M10.5898 13.34H14.8298V9.09998" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
