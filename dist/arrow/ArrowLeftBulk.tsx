...
export interface ArrowLeftBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArrowLeftBulk: React.FC<ArrowLeftBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M5.47 11.47L9.76 7.18002C10.05 6.89002 10.53 6.89002 10.82 7.18002C11.11 7.47002 11.11 7.95002 10.82 8.24002L7.81 11.25H18C18.41 11.25 18.75 11.59 18.75 12C18.75 12.41 18.41 12.75 18 12.75H7.81L10.82 15.76C11.11 16.05 11.11 16.53 10.82 16.82C10.67 16.97 10.48 17.04 10.29 17.04C10.1 17.04 9.91 16.97 9.76 16.82L5.47 12.53C5.33 12.39 5.25 12.2 5.25 12C5.25 11.8 5.33 11.61 5.47 11.47Z" fill={color}/>
</svg>
