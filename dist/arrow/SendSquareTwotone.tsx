...
export interface SendSquareTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SendSquareTwotone: React.FC<SendSquareTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M9 9.51001L12 6.51001L15 9.51001" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M12 6.51001V14.51" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</g>
