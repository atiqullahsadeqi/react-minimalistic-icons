...
export interface AirplaneSquareTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const AirplaneSquareTwotone: React.FC<AirplaneSquareTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
