...
export interface GasStationBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const GasStationBroken: React.FC<GasStationBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M3.5 5C3.5 3 4.84 2 6.5 2H14.5C16.16 2 17.5 3 17.5 5V22H3.5V9" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
