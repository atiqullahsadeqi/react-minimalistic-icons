...
export interface CourthouseBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CourthouseBroken: React.FC<CourthouseBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M4 15.91V22H20V11C20 9 19 8 17 8H7C5 8 4 9 4 11V12" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M4 12H19.42" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
