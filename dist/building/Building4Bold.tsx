...
export interface Building4BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Building4Bold: React.FC<Building4BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
