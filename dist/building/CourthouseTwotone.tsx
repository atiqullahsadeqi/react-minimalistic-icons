...
export interface CourthouseTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CourthouseTwotone: React.FC<CourthouseTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M7.99001 12V22" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinejoin="round"/>
<path opacity="0.4" d="M11.99 12V22" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinejoin="round"/>
<path opacity="0.4" d="M15.99 12V22" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinejoin="round"/>
</svg>
