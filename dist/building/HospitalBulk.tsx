...
export interface HospitalBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HospitalBulk: React.FC<HospitalBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M14.06 15H9.92998C9.41998 15 8.98999 15.42 8.98999 15.94V22H14.99V15.94C15 15.42 14.58 15 14.06 15Z" fill={color}/>
