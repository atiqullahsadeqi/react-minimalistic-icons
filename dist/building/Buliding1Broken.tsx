...
export interface Buliding1BrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Buliding1Broken: React.FC<Buliding1BrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M21 6C21 3.79 20 2 17 2H7C4 2 3 3.79 3 6V22H21V10.02" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
...
export default Buliding1Broken;
