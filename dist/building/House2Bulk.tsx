...
export interface House2BulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const House2Bulk: React.FC<House2BulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M21 9.97993V21.2499H2.95001L3.00002 9.96992C3.00002 9.35992 3.28001 8.77997 3.77001 8.39997L10.77 2.95997C11.49 2.38997 12.51 2.38997 13.23 2.95997L20.23 8.39997C20.72 8.77997 21 9.35993 21 9.97993Z" fill={color}/>
