...
export interface HouseBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HouseBroken: React.FC<HouseBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2.95 22L2.98 14.03" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
