...
export interface Buildings2BoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Buildings2Bold: React.FC<Buildings2BoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
