...
export interface SagittariusBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SagittariusBold: React.FC<SagittariusBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
