...
export interface Gemini2BrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Gemini2Broken: React.FC<Gemini2BrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12 6V3" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
...
<path d="M3 6.04004V11.0001C3 15.0001 5 17.0001 9 17.0001H15C19 17.0001 21 15.0001 21 11.0001V6.04004" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
