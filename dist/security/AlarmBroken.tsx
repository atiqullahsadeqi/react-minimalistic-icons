...
export interface AlarmBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const AlarmBroken: React.FC<AlarmBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M21 16.03V15C21 10.03 16.97 6 12 6C10.56 6 9.21 6.34 8 6.94C7.26 7.31 6.58 7.77001 5.97 8.32001C4.15 9.97001 3 12.35 3 15V22H21V19.97" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
