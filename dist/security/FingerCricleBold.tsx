...
export interface FingerCricleBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FingerCricleBold: React.FC<FingerCricleBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
