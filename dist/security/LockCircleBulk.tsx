...
export interface LockCircleBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LockCircleBulk: React.FC<LockCircleBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
