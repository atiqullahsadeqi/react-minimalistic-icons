...
export interface ScanBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ScanBroken: React.FC<ScanBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M17 9.5V14.5C17 16.5 16 17.5 14 17.5H10C8 17.5 7 16.5 7 14.5V9.5C7 7.5 8 6.5 10 6.5H14" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
