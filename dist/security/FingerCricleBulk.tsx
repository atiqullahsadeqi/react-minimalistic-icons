...
export interface FingerCricleBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FingerCricleBulk: React.FC<FingerCricleBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12.0001 9.87012C11.5101 9.87012 11.1001 10.2701 11.1001 10.7701V13.2401C11.1001 13.7401 11.5001 14.1401 12.0001 14.1401C12.5001 14.1401 12.9001 13.7401 12.9001 13.2401V10.7701C12.9001 10.2701 12.4901 9.87012 12.0001 9.87012Z" fill={color}/>
