...
export interface FingerCricleLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FingerCricleLinear: React.FC<FingerCricleLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M12.0001 14.8799C11.0901 14.8799 10.3501 14.1399 10.3501 13.2299V10.7599C10.3501 9.84989 11.0901 9.10986 12.0001 9.10986C12.9101 9.10986 13.6501 9.84989 13.6501 10.7599V13.2299C13.6501 14.1399 12.9101 14.8799 12.0001 14.8799Z" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
