...
export interface SecuritySafeBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SecuritySafeBold: React.FC<SecuritySafeBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
