...
export interface EyeSlashBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const EyeSlashBroken: React.FC<EyeSlashBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M5.60009 17.7599C4.60009 16.8999 3.69009 15.8399 2.89009 14.5899C1.99009 13.1799 1.99009 10.8099 2.89009 9.39988C4.07009 7.54988 5.51009 6.09988 7.12009 5.12988" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M17.82 5.76998C16.07 4.44998 14.07 3.72998 12 3.72998" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
