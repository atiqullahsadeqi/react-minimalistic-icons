...
export interface LockCircleBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LockCircleBold: React.FC<LockCircleBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M11.9999 15.0999C12.6074 15.0999 13.0999 14.6074 13.0999 13.9999C13.0999 13.3924 12.6074 12.8999 11.9999 12.8999C11.3924 12.8999 10.8999 13.3924 10.8999 13.9999C10.8999 14.6074 11.3924 15.0999 11.9999 15.0999Z" fill={color}/>
