...
export interface DocumentPreviousBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DocumentPreviousBroken: React.FC<DocumentPreviousBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M9.65 15H7L9 17" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M13 15H12" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
