...
export interface DocumentForwardTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DocumentForwardTwotone: React.FC<DocumentForwardTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M11 17L13 15L11 13L13 15H7" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
