...
export interface DocumentDownloadBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DocumentDownloadBroken: React.FC<DocumentDownloadBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M9 14.35V17L11 15" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M9 11V12" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
