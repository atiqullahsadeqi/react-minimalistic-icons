...
export interface NoteFavoriteBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const NoteFavoriteBroken: React.FC<NoteFavoriteBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
