...
export interface DocumentCloudBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DocumentCloudBold: React.FC<DocumentCloudBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M14.7601 19.2599C12.4101 19.4299 12.4101 22.8299 14.7601 22.9999H20.3201C20.9901 22.9999 21.6501 22.7499 22.1401 22.2999C23.7901 20.8599 22.9101 17.9799 20.7401 17.7099C19.9601 13.0199 13.1801 14.7999 14.7801 19.2699" fill={color}/>
