...
export interface ClipboardExportTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ClipboardExportTwotone: React.FC<ClipboardExportTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M20.9991 22L15.0391 16.04" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</g>
</svg>
