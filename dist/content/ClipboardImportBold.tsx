...
export interface ClipboardImportBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ClipboardImportBold: React.FC<ClipboardImportBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
