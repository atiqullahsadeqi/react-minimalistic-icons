...
export interface DocumentFilterBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DocumentFilterBroken: React.FC<DocumentFilterBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22.0002 9C22.0002 5.88 21.2202 3.91999 19.4102 2.89999C18.9002 2.60999 17.8802 2.38999 16.9502 2.23999" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M2 12V15C2 20 4 22 9 22H15C20 22 22 20 22 15V13" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
