...
export interface DocumentSketchBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DocumentSketchBroken: React.FC<DocumentSketchBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.29 17.7C9.94001 18.05 9.36001 18.05 9.01001 17.7L6.55001 15.24C6.26001 14.95 6.21001 14.44 6.44001 14.1L7.57001 12.4C7.72001 12.18 8.06001 12 8.32001 12H10.97C11.24 12 11.58 12.18 11.72 12.4L12.85 14.1C13.08 14.44 13.03 14.95 12.74 15.24" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
