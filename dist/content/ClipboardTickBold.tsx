...
export interface ClipboardTickBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ClipboardTickBold: React.FC<ClipboardTickBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
