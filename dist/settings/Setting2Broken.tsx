...
export interface Setting2BrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Setting2Broken: React.FC<Setting2BrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
