...
export interface MoreTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MoreTwotone: React.FC<MoreTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M12 10C10.9 10 10 10.9 10 12C10 13.1 10.9 14 12 14C13.1 14 14 13.1 14 12C14 10.9 13.1 10 12 10Z" stroke={color} strokeWidth="1.5"/>
</svg>
