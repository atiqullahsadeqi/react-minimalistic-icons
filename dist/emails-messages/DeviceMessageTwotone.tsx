...
export interface DeviceMessageTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DeviceMessageTwotone: React.FC<DeviceMessageTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
