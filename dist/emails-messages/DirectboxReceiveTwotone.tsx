...
export interface DirectboxReceiveTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DirectboxReceiveTwotone: React.FC<DirectboxReceiveTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M5 12V8C5 5.99 5 4.33 8 4.04" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path opacity="0.4" d="M19 12V8C19 5.99 19 4.33 16 4.04" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
