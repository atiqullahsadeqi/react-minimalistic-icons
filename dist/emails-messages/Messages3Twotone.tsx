...
export interface Messages3TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Messages3Twotone: React.FC<Messages3TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
