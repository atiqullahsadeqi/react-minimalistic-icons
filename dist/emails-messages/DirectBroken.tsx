...
export interface DirectBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DirectBroken: React.FC<DirectBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M13.6602 10H14.5002" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M9.5 10H11.08" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M10.3398 7H13.6698" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
