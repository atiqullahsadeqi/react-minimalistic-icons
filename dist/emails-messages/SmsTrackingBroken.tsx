...
export interface SmsTrackingBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SmsTrackingBroken: React.FC<SmsTrackingBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M22 12.98V15.5C22 19 20 20.5 17 20.5H7" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M2 8.5C2 5 4 3.5 7 3.5H17C20 3.5 22 5 22 8.5" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
