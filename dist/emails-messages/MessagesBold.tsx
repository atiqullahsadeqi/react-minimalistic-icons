...
export interface MessagesBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MessagesBold: React.FC<MessagesBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M21.9999 12.86C21.9999 15.15 20.8199 17.18 18.9999 18.46L17.6599 21.41C17.3499 22.08 16.4499 22.21 15.9799 21.64L14.4999 19.86C12.6399 19.86 10.9299 19.23 9.62988 18.18L10.2299 17.47C14.8499 17.12 18.4999 13.46 18.4999 9C18.4999 8.24 18.3899 7.49 18.1899 6.77C20.4599 7.97 21.9999 10.25 21.9999 12.86Z" fill={color}/>
