...
export interface MessageTickBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const MessageTickBulk: React.FC<MessageTickBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
