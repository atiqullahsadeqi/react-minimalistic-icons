...
export interface SmsNotificationBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const SmsNotificationBulk: React.FC<SmsNotificationBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
