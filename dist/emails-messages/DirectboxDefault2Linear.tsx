...
export interface DirectboxDefault2LinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DirectboxDefault2Linear: React.FC<DirectboxDefault2LinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M10.5498 9.23H13.8798" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M9.72021 6.23H14.7202" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
