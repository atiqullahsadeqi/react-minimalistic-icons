...
export interface DirectboxSendLinearProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DirectboxSendLinear: React.FC<DirectboxSendLinearProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M5 12V9.99999C5 7.98999 5 6.32999 8 6.03999" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M19 12V9.99999C19 7.98999 19 6.32999 16 6.03999" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
