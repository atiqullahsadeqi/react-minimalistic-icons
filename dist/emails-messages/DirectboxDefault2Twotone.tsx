...
export interface DirectboxDefault2TwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DirectboxDefault2Twotone: React.FC<DirectboxDefault2TwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M10.5498 9.23H13.8798" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path opacity="0.4" d="M9.72021 6.23H14.7202" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>

  );
};

export default DirectboxDefault2Twotone;
