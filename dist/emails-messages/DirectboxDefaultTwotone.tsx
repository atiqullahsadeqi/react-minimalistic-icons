...
export interface DirectboxDefaultTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const DirectboxDefaultTwotone: React.FC<DirectboxDefaultTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M19 12V6C19 3.79 19 2 15 2H9C5 2 5 3.79 5 6V12" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
