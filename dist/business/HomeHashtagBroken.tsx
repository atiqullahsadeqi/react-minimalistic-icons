...
export interface HomeHashtagBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HomeHashtagBroken: React.FC<HomeHashtagBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M13.5 9H10.5C8.85 9 7.5 10.35 7.5 12V15C7.5 16.65 8.85 18 10.5 18H13.5C15.15 18 16.5 16.65 16.5 15V12" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
