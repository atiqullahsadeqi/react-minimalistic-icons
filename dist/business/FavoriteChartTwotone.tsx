...
export interface FavoriteChartTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const FavoriteChartTwotone: React.FC<FavoriteChartTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
