...
export interface Chart1BrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Chart1Broken: React.FC<Chart1BrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M7 10C7 8.9 6.6 8 5.4 8H4.6C3.4 8 3 8.9 3 10V22H7V13.99" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
