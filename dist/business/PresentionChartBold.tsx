...
export interface PresentionChartBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const PresentionChartBold: React.FC<PresentionChartBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
