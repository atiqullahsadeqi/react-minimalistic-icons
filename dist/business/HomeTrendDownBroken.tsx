...
export interface HomeTrendDownBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const HomeTrendDownBroken: React.FC<HomeTrendDownBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M11.17 14L10.7 14.7L7.5 11.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M16.5 16.5L14.99 14.99L14 14" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
