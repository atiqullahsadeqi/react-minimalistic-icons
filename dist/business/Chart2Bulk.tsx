...
export interface Chart2BulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const Chart2Bulk: React.FC<Chart2BulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M16.4201 7.8099V16.1899C16.4201 16.8299 15.9001 17.3499 15.2601 17.3499C14.6101 17.3499 14.0901 16.8299 14.0901 16.1899V7.8099C14.0901 7.1699 14.6101 6.6499 15.2601 6.6499C15.9001 6.6499 16.4201 7.1699 16.4201 7.8099Z" fill={color}/>
