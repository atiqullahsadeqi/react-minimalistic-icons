...
export interface TradeBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const TradeBold: React.FC<TradeBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M18.4102 22H21.0002C21.5502 22 22.0002 21.55 22.0002 21V18.41C22.0002 17.52 20.9202 17.07 20.2902 17.7L17.7002 20.29C17.0802 20.92 17.5202 22 18.4102 22Z" fill={color}/>
</svg>
