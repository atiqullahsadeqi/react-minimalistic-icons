...
export interface CardCoinBoldProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CardCoinBold: React.FC<CardCoinBoldProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2.5 17.31C2.22 17.31 2 17.53 2 17.81V18.81V19.8C2 21.56 2.44 22 4.22 22H9.78C11.56 22 12 21.56 12 19.8V18.81V17.81C12 17.53 11.78 17.31 11.5 17.31H2.5Z" fill={color}/>
