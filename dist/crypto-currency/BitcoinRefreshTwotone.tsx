...
export interface BitcoinRefreshTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BitcoinRefreshTwotone: React.FC<BitcoinRefreshTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M2.74023 9.67993V11.9999C2.74023 17.1199 6.89024 21.2599 12.0002 21.2599C14.9202 21.2599 17.5302 19.8999 19.2302 17.7899" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<g opacity="0.4">
