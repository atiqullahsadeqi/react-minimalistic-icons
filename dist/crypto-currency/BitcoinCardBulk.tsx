...
export interface BitcoinCardBulkProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const BitcoinCardBulk: React.FC<BitcoinCardBulkProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M22 7.53998V16.46C22 18.75 20.14 20.6 17.85 20.6H6.15C3.86 20.6 2 18.75 2 16.46V7.53998C2 5.24998 3.86 3.40002 6.15 3.40002H17.85C20.14 3.40002 22 5.24998 22 7.53998Z" fill={color}/>
