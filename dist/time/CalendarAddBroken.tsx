...
export interface CalendarAddBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CalendarAddBroken: React.FC<CalendarAddBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.4898 19.0499H16.5098" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
