...
export interface CalendarRemoveTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const CalendarRemoveTwotone: React.FC<CalendarRemoveTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M19.05 18.02L16.93 20.14" stroke={color} strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
