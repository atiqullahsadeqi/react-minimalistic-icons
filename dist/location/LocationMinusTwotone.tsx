...
export interface LocationMinusTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LocationMinusTwotone: React.FC<LocationMinusTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M9.25 11H14.75" stroke={color} strokeWidth="1.5" strokeLinecap="round"/>
