...
export interface LocationTickTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const LocationTickTwotone: React.FC<LocationTickTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M9.25 11.5L10.75 13L14.75 9" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
</svg>
