...
export interface GlobalSearchTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const GlobalSearchTwotone: React.FC<GlobalSearchTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<g opacity="0.4">
<path d="M7.99961 3H8.99961C7.04961 8.84 7.04961 15.16 8.99961 21H7.99961" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
