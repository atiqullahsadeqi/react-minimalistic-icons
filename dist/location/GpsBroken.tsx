...
export interface GpsBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const GpsBroken: React.FC<GpsBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M8.5 5.36505C9.54486 4.81273 10.7359 4.5 12 4.5C16.1421 4.5 19.5 7.85786 19.5 12C19.5 16.1421 16.1421 19.5 12 19.5C7.85786 19.5 4.5 16.1421 4.5 12C4.5 10.7359 4.81273 9.54486 5.36505 8.5" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
