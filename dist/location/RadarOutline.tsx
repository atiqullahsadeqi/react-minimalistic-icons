...
export interface RadarOutlineProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const RadarOutline: React.FC<RadarOutlineProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
