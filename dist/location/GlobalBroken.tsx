...
export interface GlobalBrokenProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const GlobalBroken: React.FC<GlobalBrokenProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path d="M7.9999 3H8.9999C8.5099 4.46 8.1499 5.95 7.8999 7.46" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path d="M16.13 16.36C15.88 17.92 15.51 19.48 15 21" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
