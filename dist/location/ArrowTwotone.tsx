...
export interface ArrowTwotoneProps {
  size?: number | string;
  color?: string;
  className?: string;
...
const ArrowTwotone: React.FC<ArrowTwotoneProps> = ({ 
  size = 24, 
  color = "currentColor", 
  ...props 
}) => {
...
<path opacity="0.4" d="M12 22V20" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
<path opacity="0.4" d="M12 18V16" stroke={color} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
